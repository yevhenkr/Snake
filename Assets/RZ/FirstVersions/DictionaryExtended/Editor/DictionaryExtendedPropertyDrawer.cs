...
public class DictionaryExtendedPropertyDrawer : PropertyDrawer
{
    ...
    static DictionaryExtendedPropertyDrawer()
    {
...
public class DictionaryExtendedStoragePropertyDrawer : PropertyDrawer
{
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        property.Next(true);

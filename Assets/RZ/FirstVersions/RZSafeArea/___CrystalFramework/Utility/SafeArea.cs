...
namespace Crystal
{
    ...
    , ILayoutIgnorer
    {
        ...
        override protected void OnTransformParentChanged()// work on disabled
        {
            Refresh(true);
        }
        override protected void OnRectTransformDimensionsChange()// work on disabled
        {
            Refresh(true);
        }
        ...
        void Refresh(bool force)
        {
                ...
                || Screen.orientation != LastOrientation)
            {
                ...
                // See https://forum.unity.com/threads/569236/#post-4473253 
                // and https://forum.unity.com/threads/569236/page-2#post-5166467
        ...
        void ApplySafeArea(Rect r)
        {
            ...
            // Convert safe area rectangle from absolute pixels to
            // normalised anchor coordinates

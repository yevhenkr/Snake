...
namespace RZ.JSON
{
    ...
    public class JSONValue
    {
        ...
        public override string ToString()
        {
            switch (Type)
            {
                default: case JSONValueType.Null: return "null";
                case JSONValueType.Object: return Obj.ToString();
        ...
        ////////// RZ: //////////
        // ToStringForced, ToNumberForced, ToBoolForced, 
        public string StringForced()
        {
            switch (Type)
            {
                default: case JSONValueType.Null: return string.Empty;
                case JSONValueType.Object: return Obj.ToString();
                case JSONValueType.Array: return Array.ToString();
                case JSONValueType.Boolean: return Boolean ? "true" : "false";
                case JSONValueType.Number: return Number.ToString();
        ...
        public double NumberForced()
        {
            switch (Type)
            {
                default: case JSONValueType.Null: return 0;
                case JSONValueType.Object: return double.Parse(Obj.ToString());
                case JSONValueType.Array: return double.Parse(Array.ToString());
                case JSONValueType.Boolean: return Boolean ? 1 : 0;
                case JSONValueType.Number: return Number;
                case JSONValueType.String: return string.IsNullOrEmpty(Str) ? 0 : double.Parse(Str);
            }
        }

        public bool BoolForced()
        {
            string s;
            switch (Type)
            {
                default: case JSONValueType.Null: return false;
                case JSONValueType.Boolean: return Boolean;
                case JSONValueType.Number: return Number > 0 ? true : false;
                case JSONValueType.Object:
                    s = Obj.ToString().ToLower().Trim();
                    return (s == "true" || s == "1" || s == "yes" || s == "on");
                case JSONValueType.Array:
                    s = Array.ToString().ToLower().Trim();
                    return (s == "true" || s == "1" || s == "yes" || s == "on");
                case JSONValueType.String:
                    s = Str.ToLower().Trim();
                    return (s == "true" || s == "1" || s == "yes" || s == "on");
    ...
    public class JSONObject : IEnumerable<KeyValuePair<string, JSONValue>>
    {
        ...
        public string GetString(string key)
        {
            ...
            else if (value.Type != JSONValueType.String)
            {
                JSONLogger.Error(key + "(string) not String");
                return string.Empty;
            }
            else
            {
        ...
        public double GetNumber(string key)
        {
            ...
            {
                JSONLogger.Error(key + " not Number");
                return double.NaN;
            }
            else
            {
        ...
        public bool GetBoolean(string key)
        {
            ...
            {
                JSONLogger.Error(key + " not Boolean");
                return false;
            }
            else
            {
        ...
        {
            var value = GetValue(key);
            return value == null ? string.Empty : value.StringForced();
        }

        public double GetNumberForced(string key)
        {
            var value = GetValue(key);
            return value == null ? 0 : value.NumberForced();
        }

        public bool GetBooleanForced(string key)
        {
            var value = GetValue(key);
            return value == null ? false : value.BoolForced();
        }
        ////////// RZ } //////////
        ...
        public JSONObject GetObject(string key)
        {
            ...
            {
                JSONLogger.Error(key + " not JSONObject");
                return null;
            }
            else
            {
        ...
        public JSONArray GetArray(string key)
        {
            ...
            {
                JSONLogger.Error(key + " not JSONArray");
                return null;
            }
            else
            {

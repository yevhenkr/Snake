...
namespace RZ
{
#if UNITY_EDITOR
    using UnityEditor;
    [CustomEditor(typeof(LayoutSize))]
    public class LayoutSizeEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            LayoutSize layoutMax = target as LayoutSize;
    ...
    [AddComponentMenu("Layout/Layout Size")]
    [RequireComponent(typeof(RectTransform))]
    [System.Serializable]
    public class LayoutSize : LayoutElement
    {
...
#pragma warning disable 0114 //hides inherited member `UnityEngine.UI.LayoutElement.OnValidate().
        // protected override
        void OnValidate()
        {
            // base.OnValidate();
